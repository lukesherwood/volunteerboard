...
events = Event.create([{name: "greenpeace monday event", date:"27/04/2020 19:00", location: "Downtown Cleveland RSA", user_id: user.id, organisation_id: org.id}, {name: "greenpeace friday event", date:"01/05/2020 19:00", location: "Downtown Cleveland RSA", user_id: user.id, organisation_id: org.id} ])
...
events.first.volunteers << volunteer
events.last.volunteers = [volunteer, volunteer2]
